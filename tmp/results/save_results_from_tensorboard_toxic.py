...
csv_data = [
    [
        ...
        "Seed",
        "Best Epoch",
        "Accuracy Official Set",
        "Accuracy Generated Set",
    ]
]
        ...
        for method in methods:
            ...
            for seed_dir in method_dir.iterdir():
                ...
                if best_epoch is not None:
                    csv_data.append(
                        [dataset, method, seed, best_epoch, best_worst_acc, best_acc]
                    )
                    print(
                        f"✅ {dataset}-{method}-Seed {seed}: Best Epoch {best_epoch} | Accuracy Official Set: {best_worst_acc:.4f} | Accuracy Generated Set: {best_acc:.4f}"
                    )
...
results = grouped.agg(
    Test_Overall_Mean=("Accuracy Official Set", "mean"),
    Test_Overall_Std=("Accuracy Official Set", "std"),
    Test_Worst_Group_Mean=("Accuracy Generated Set", "mean"),
    Test_Worst_Group_Std=("Accuracy Generated Set", "std"),
)

# Print results in Markdown table format
print(
    "| Dataset | Method | Accuracy Official Set (Mean ± Std) | Accuracy Generated Set (Mean ± Std) |"
)
print(
    "|---------|--------|------------------------------------|--------------------------------------|"
)
