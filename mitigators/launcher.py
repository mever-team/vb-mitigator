...
def parse_args():
    ...
    parser.add_argument("--exp_root", type=str, default="exp/urbancars")
    ...
    if args.wandb:
        args.wandb_project_name = "badd urban cars"
        # args.wandb_entity = "online"
...
def main():
    ...
    for group_label in group_label_list:
        for seed in range(args.start_seed, args.start_seed + args.num_seed):
