...
def get_stanford_dogs_loader(
    ...
    if split == "train":
        ...
        train_dataset = dogs(
            root=root, train=True, cropped=False, transform=transform, download=False
        )
        ...
        test_dataset = dogs(
            root=root, train=False, cropped=False, transform=transform, download=False
        )
...
@register_dataset("stanford_dogs")
def build_stanford_dogs(cfg):
