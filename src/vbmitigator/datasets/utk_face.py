...
class BiasedUTKFace:
    def __init__(
        ...
        if save_path.is_dir():
            ...
            pickle.dump(train_dataset, open(save_path / "train_dataset.pkl", "wb"))
            pickle.dump(test_dataset, open(save_path / "test_dataset.pkl", "wb"))
...
@register_dataset("utkface")
def build_utkface(cfg):
